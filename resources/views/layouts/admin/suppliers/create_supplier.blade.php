                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name" id="company_name" class="form-control @error('company_name') is-invalid @enderror" value="{{ old('company_name') }}" placeholder="Enter company name" autocomplete="company name" autofocus>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-check">
                                    <input class="form-check-input" name="status" type="checkbox" value="active" id="status">
                    ...
                    <div class="tab-pane fade" role="tabpanel" aria-labelledby="address" id="address">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-danger tinker-pro-btn">Add Supplier</button>
                                </div>
                            </div>
                        </div>
                    </div>
