...
<section class="page-header mb-3 mt-2">
    <h3 class="text-uppercase pos-text-color mb-0" style="font-weight: 900;">Add User</h3>
                    ...
                    <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="personal" id="personal">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group form-check">
                                <input class="form-check-input" name="active" type="checkbox" value="active" id="active">
                    ...
                    <div class="tab-pane fade" role="tabpanel" aria-labelledby="others" id="others">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-4">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-danger tinker-pro-btn">Create Account</button>
                                </div>
                            </div>
