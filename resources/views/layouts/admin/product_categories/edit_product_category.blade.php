                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_name" id="category_name" value="{{ $category->category_name }}" class="form-control @error('category_name') is-invalid @enderror" value="{{ old('category_name') }}" placeholder="Enter category name" autocomplete="category-name" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" value="{{ $category->description }}" class="form-control bg-white @error('description') is-invalid @enderror" placeholder="Enter description" cols="30" rows="10"></textarea>
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-danger tinker-pro-btn">Update Category</button>
                        </div>
